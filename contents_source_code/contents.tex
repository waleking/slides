...
\node (chapK2Social) at (0,2.8) [anchor=west,fill=frenchblue,draw=frenchblue, text=white] {2.基于知识迁移的社交媒体事件检测通用框架K2Social};
\node (chapTransDetector) at (0,1.6) [anchor=west,fill=frenchblue,draw=frenchblue, text=white] {3.基于知识库结构的主题抽取与迁移方法};
...
\node (chapConclusion) at (0,-2) [anchor=west,fill=frenchblue,draw=frenchblue, text=white] {6.总结与展望};
